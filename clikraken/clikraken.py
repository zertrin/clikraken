...
def parse_args():
    ...
    parser.add_argument('-v', '--version', action='store_const', const=version, dest='func')
    ...
    parser_depth.set_defaults(func=depth)
    ...
    parser_last_trades.set_defaults(func=last_trades)
    ...
    parser_place.set_defaults(func=place_order)
    ...
    parser_olist.set_defaults(func=list_orders)
